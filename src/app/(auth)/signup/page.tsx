...
export default function SignupPage() {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row-reverse">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12 bg-white relative shadow-2xl z-10">
        <Link
          href="/"
        ...
        <div className="w-full max-w-md mx-auto mt-10 md:mt-0">
          <div className="mb-10 text-center md:text-left">
            ...
            <p className="text-gray-500">
              Join QuickHire today to find your new career.
            </p>
          </div>
      ...
      <div className="hidden md:flex w-1/2 bg-[#0A1445] relative items-center justify-center overflow-hidden flex-col p-12 text-center">
        <div className="absolute inset-0 opacity-10 z-0 mix-blend-screen -scale-x-100">
          <Image
            src={patternImage}
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <p className="text-blue-100 text-lg">
            Create an account to browse jobs, track applications, and level up
