...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      {/* Left side Form */}
      <div className="w-full md:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12 bg-white relative">
        <Link
          href="/"
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center justify-between mt-2">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="rounded border-gray-300 text-[#3B41E3] focus:ring-[#3B41E3]"
                />
              ...
              <Link
                href="#"
                className="text-sm font-semibold text-[#3B41E3] hover:text-blue-700 hover:underline"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6">
            <Button
              variant="outline"
              className="w-full justify-center h-12 text-gray-700 font-medium border-gray-200 hover:bg-gray-50"
            >
              <svg
          ...
          <p className="mt-8 text-center text-sm text-gray-600 font-medium">
            ...
            <Link
              href="/signup"
              className="font-bold text-[#3B41E3] hover:underline"
            >
              Sign up
            </Link>
          </p>
      ...
      <div className="hidden md:flex w-1/2 bg-[#3B41E3] relative items-center justify-center overflow-hidden flex-col p-12 text-center">
        ...
        <div className="relative z-10 max-w-lg">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
            Find your dream job with QuickHire
          </h2>
          <p className="text-blue-100 text-lg">
            Join thousands of professionals landing jobs in startups and top
